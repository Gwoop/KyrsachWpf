...
(
	...
	--SERIAL - автоинкремнтириующийся тип данных, равен типу данных int
	--constraint - объект ограниченный на поле (Назначение ограничения(Primary key, foreign key и тд))
	...
	-- constraint check - выполнение проверка на соответствия условия вода 
	-- similar to - создание маски ввода(Проверка ввода при помощи Regex(Поле similar to 'Regexp'))
...
(
	...
	Date_Bithdais varchar(10) not null constraint Ch_Date_Bithdais
	check(Date_Bithdais similar to '[0-9][0-9].[0-9][0-9].[0-9][0-9][0-9][0-9]' ),
	Client_Number varchar (19) not null constraint Ch_Employee_Number
